...
<div className='px-3 pb-5' style={{fontSize: '2rem'}}>
    <div className='row pb-5'>
        <div className='col-6' style={{color: "#FF5C00", fontSize: '1.2rem'}}>
            ...
            Contributor(s):
            {textExample.contributors.map((contributor) => {
                return(
                    <div>
                        {contributor} <br />
                    </div>
        ...
        <div className='col-6' style={{color: "#FF5C00", fontSize: '4rem'}}>
            <div className='w-75'>
                {textExample.title}<br /><br /><br />
            </div>
        </div>
    </div>
    {textExample.textBlocks.map((text,index) => {
        return(
