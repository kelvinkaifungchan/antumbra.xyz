...
<footer className={`p-3 ${styles.screenSmall}`}>
    <div className='row' style={{color: "#FF5C00",fontSize: '1.8rem'}}>
        ...
        Antumbra.dao is a student-run autonomous broadcasting organisation.
        </div>
...
<footer className={`p-3 ${styles.screenBig}`}>
    <div className='row' style={{color: "#FF5C00",fontSize: '1.8rem'}}>
        ...
        <div className='col-12 col-md-6 col-lg-3' style={{fontSize:'1rem', opacity:'0.7', width:"20%"}}>
        Antumbra is a student-run autonomous broadcasting organisation.
        </div>
